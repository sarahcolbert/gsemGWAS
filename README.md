...
You can create a results file with significant QSNPs (qsnps.csv) and a file with the summary statistics with significant Qsnps removed (CF_sumstats_cleaned.csv) using the script [pull_Qsnps.bash](https://github.com/sarahcolbert/quickSEMGWAS/blob/master/scripts/pull_Qsnps.bash).
